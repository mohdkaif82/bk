from .models import Category,Product,Review,ProImage,Cart,Cartitems,OrderItem,Order
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = [ "id", "name", "description", "reviews","inventory", "price", "images", "uploaded_images","category"]
...
class CartSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Cart
        fields = ["id", "items", "grand_total","owner"]
