...
class PatientManualReport(models.Model):
    ...
    pulse=models.CharField(max_length=5,blank=True, null=True)
    temperature=models.CharField(max_length=20,blank=True, null=True)
    temperature_part=models.CharField(max_length=50,blank=True, null=True)
    blud_pressure_up=models.CharField(max_length=50,blank=True, null=True)
    blud_pressure_down=models.CharField(max_length=50,blank=True, null=True)
    position=models.CharField(max_length=50,blank=True, null=True)
    weight=models.CharField(max_length=50,blank=True, null=True)
    resp_rate=models.CharField(max_length=50,blank=True, null=True)
    creatinine_level=models.CharField(max_length=50,blank=True, null=True)
    haemoglobin_level=models.CharField(max_length=20,blank=True, null=True)
    urea_level=models.CharField(max_length=50,blank=True, null=True)
